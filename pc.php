...
<div class="card-body">
                <table class="table">
                    ...
                    <tbody>
                        <?php
                        $sql2   = "select * from product where cat_id='A0002' order by prod_id desc ";
                        ...
                        ?>
                            <tr>
                                ...
                                <td scope="row">
                                    <a href="edit.php?op=edit&prod_id=<?php echo $prod_id ?>"><button type="button" class="btn btn-warning">Edit</button></a> 
                                    <a href="delete.php?op=delete&prod_id=<?php echo $prod_id?>" onclick="return confirm('Continue to delete?')"><button type="button" class="btn btn-danger">Delete</button></a>            
